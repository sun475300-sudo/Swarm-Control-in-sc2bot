...
```powershell
# 프로필에 추가
[System.Environment]::SetEnvironmentVariable("GOOGLE_API_KEY", "AIzaSyBDdPWJyXs56AxeCPmqZpySFOVPjjSt_CM", "User")
[System.Environment]::SetEnvironmentVariable("GEMINI_API_KEY", "AIzaSyBDdPWJyXs56AxeCPmqZpySFOVPjjSt_CM", "User")
```
...
1. ❌ **코드에 직접 하드코딩하지 마세요**
   ```python
   # 나쁜 예
   api_key = "AIzaSyBDdPWJyXs56AxeCPmqZpySFOVPjjSt_CM"
   ```
