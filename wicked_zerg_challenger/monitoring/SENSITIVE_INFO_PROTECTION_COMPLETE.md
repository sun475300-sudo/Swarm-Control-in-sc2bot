...
- 실제 API 키 (`AIzaSyBDdPWJyXs56AxeCPmqZpySFOVPjjSt_CM`) → `[API_KEY_REMOVED]` 또는 `[YOUR_API_KEY]`로 변경
- 모든 예제에서 실제 키 제거 완료
...
```powershell
# 모든 파일에서 API 키 검색
Select-String -Path "**/*" -Pattern "AIzaSyBDdPWJyXs56AxeCPmqZpySFOVPjjSt_CM" -Recurse
